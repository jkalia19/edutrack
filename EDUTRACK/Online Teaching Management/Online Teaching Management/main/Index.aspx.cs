    ...
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        protected void btn1_Click(object sender, EventArgs e)
        {
            ...
            if (DropDownList1.SelectedItem.Text == "Admin")
            {
                ...
                cmd.Parameters.Add("@u_name", SqlDbType.NVarChar, 50).Value = Txt_reg.Text;
            ...
            else if (DropDownList1.SelectedItem.Text == "Student")
            {
                ...
                con.ConnectionString = ConfigurationManager.ConnectionStrings["cn"].ConnectionString;
                con.Open();
                cmd = new SqlCommand("select sr_name, sr_password from Student_registration_table_edutrack where sr_name=@sr_name", con);
                cmd.Parameters.Add("@sr_name", SqlDbType.NVarChar, 50).Value = Txt_reg.Text;
                dr = cmd.ExecuteReader();
                if (dr.HasRows)
                {
                    dr.Read();
            ...
            {
                Response.Redirect("~/Partner/Online_Teaching/Partnership/Home.aspx?x=" + Txt_reg.Text);
                Session["id"] = Txt_reg.Text;
