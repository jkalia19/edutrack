...
<asp:Content ID="Content2" runat="server" 
    ...
    <asp:LinkButton ID="LinkButton5" runat="server" Font-Bold="True" 
        Font-Names="Adobe Heiti Std R" Font-Underline="False" ForeColor="#003366">View Profile</asp:LinkButton>
    <br />
    <br />
    &nbsp;&nbsp;
    <asp:LinkButton ID="LinkButton6" runat="server" Font-Bold="True" 
        Font-Names="Adobe Heiti Std R" Font-Underline="False" ForeColor="#003366">Update Profile</asp:LinkButton>
    <br />
    <br />
    &nbsp;&nbsp;
    <asp:LinkButton ID="LinkButton7" runat="server" Font-Bold="True" 
        Font-Names="Adobe Heiti Std R" Font-Underline="False" ForeColor="#003366">Insert Profile Pic</asp:LinkButton>
    <br />
    <br />
&nbsp;&nbsp;
    <asp:LinkButton ID="LinkButton8" runat="server" Font-Bold="True" 
        Font-Names="Adobe Heiti Std R" Font-Underline="False" ForeColor="#003366">Search Employee</asp:LinkButton>
    <br />
    <br />
</asp:Content>
